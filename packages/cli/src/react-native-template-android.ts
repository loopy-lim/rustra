...
target_link_libraries(rustra_bridge PRIVATE rustra_static fbjni::fbjni ReactAndroid::jsi ReactAndroid::folly_runtime ReactAndroid::glog ReactAndroid::reactnative android log)
`;
}
