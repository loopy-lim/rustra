...
BUILD_TARGETS=(
  ...
  "$REPO_ROOT/examples/lynx-calculator/dist"
  "$REPO_ROOT/examples/lynx-calculator/host/HostApp.app"
  "$REPO_ROOT/examples/lynx-calculator/frame.raw"
  "$REPO_ROOT/examples/lynx-calculator/modules/rustra-lynx/android/rust/lib"
  "$REPO_ROOT/examples/lynx-calculator/modules/rustra-lynx/ios/rust/lib"
  "$REPO_ROOT/examples/lynx-calculator/android/.gradle"
  "$REPO_ROOT/examples/lynx-calculator/android/build"
  "$REPO_ROOT/examples/lynx-calculator/android/app/build"
  "$REPO_ROOT/examples/lynx-calculator/android/app/.cxx"
  "$REPO_ROOT/examples/lynx-calculator/ios/build"
  "$REPO_ROOT/examples/lynx-calculator/android/app/src/main/assets/main.lynx.bundle"
  "$REPO_ROOT/examples/lynx-calculator/ios/app/Resources/app.lynx.js"
  "$REPO_ROOT/examples/lynx-tauri-spike/dist"
  "$REPO_ROOT/examples/lynx-tauri-spike/SpikeApp.app"
  "$REPO_ROOT/examples/lynx-tauri-spike/src-tauri/gen"
  ...
  "$REPO_ROOT/runner/template/target"
  "$REPO_ROOT/runner/template/backend/target"
  "$REPO_ROOT/runner/template/app/dist"
  "$REPO_ROOT/runner/template/app/generated"
  "$REPO_ROOT/runner/template/desktop/TemplateApp.app"
  "$REPO_ROOT/runner/template/desktop/src-tauri/gen"
  "$REPO_ROOT/runner/template/desktop/src-tauri/target"
  "$REPO_ROOT/runner/template/mobile-android/.gradle"
  "$REPO_ROOT/runner/template/mobile-android/build"
  "$REPO_ROOT/runner/template/mobile-android/app/build"
  "$REPO_ROOT/runner/template/mobile-android/app/.cxx"
  "$REPO_ROOT/runner/template/mobile-android/app/src/main/assets/main.lynx.bundle"
  "$REPO_ROOT/runner/template/mobile-android/modules/rustra-lynx/rust"
  "$REPO_ROOT/runner/template/mobile-ios/build"
  "$REPO_ROOT/runner/template/mobile-ios/RustraTemplate.xcodeproj"
  "$REPO_ROOT/runner/template/mobile-ios/RustraTemplate.xcworkspace"
  "$REPO_ROOT/runner/template/mobile-ios/app/Resources/app.lynx.js"
  "$REPO_ROOT/runner/template/mobile-ios/modules/rustra-lynx/rust"
...
DEEP_TARGETS=(
  ...
  "$REPO_ROOT/examples/lynx-calculator/node_modules"
  "$REPO_ROOT/examples/lynx-calculator/ios/Pods"
  "$REPO_ROOT/examples/lynx-tauri-spike/node_modules"
  ...
  "$REPO_ROOT/runner/template/app/node_modules"
  "$REPO_ROOT/runner/template/mobile-ios/Pods"
)
