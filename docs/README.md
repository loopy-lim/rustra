...
| [Glossary](glossary.md) ([한국어](glossary.ko.md))                                                                                                 | All          | Canonical spellings and disambiguation of overloaded terms (Frame, wire/dev tiers, hot-core, host, snapshot, gate)                                                                                   |
...
| [Migration Notes](migrations/0.3-to-0.4.md), [0.5→0.6](migrations/0.5-to-0.6.md), [post-0.9 Frame & audit](migrations/post-0.9-frame-and-audit.md) | Users        | Step-by-step notes when jumping rustra minor versions                                                                                                                                                |
...
| [Release Matrix](release-matrix.md) ([한국어](release-matrix.ko.md))                                                                               | Contributors | Per-target release verification matrix — what is verified where                                                                                                                                      |
| [Gate Map](gate-map.md) ([한국어](gate-map.ko.md))                                                                                                 | Contributors | Single map of every gate — protected invariant, local command, CI job, required-check status                                                                                                         |
| [API Surface Gate](../api-surface/README.md)                                                                                                       | Contributors | Snapshot comparison procedure, `--update` rules, TS/Rust boundary scope                                                                                                                              |
