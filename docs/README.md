...
| [Lynx (LynxJS) 통합 가이드](lynx-integration.md)                | 사용자 | Lynx 듀얼스레드 엔진 연동 아키텍처 및 Native Module 구현      |
| [Lynx 심층 조사 보고서](research/lynx-architecture-research.md) | 연구   | LynxJS Dual-Thread 아키텍처, PrimJS, FFI (JSI/NAPI/PAPI) 분석 |
