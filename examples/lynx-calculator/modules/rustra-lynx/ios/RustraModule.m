...
// Rust staticlib (examples/calculator) FFI 심볼.
// rkyv V2 단일 디스패치: payload 바이너리 → 결과 바이너리.
extern uint8_t *rustra_calculator_invoke_rkyv_v2(const uint8_t *payload,
                                                 size_t payload_len,
                                                 size_t *out_len);
extern void rustra_calculator_free_buffer(uint8_t *ptr, size_t len);
